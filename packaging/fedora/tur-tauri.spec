...
install -D -m 0644 packaging/shared/io.github.greykaizen.tur.desktop %{buildroot}%{_datadir}/applications/io.github.greykaizen.tur.desktop
install -D -m 0644 packaging/shared/io.github.greykaizen.tur.metainfo.xml %{buildroot}%{_datadir}/metainfo/io.github.greykaizen.tur.metainfo.xml
